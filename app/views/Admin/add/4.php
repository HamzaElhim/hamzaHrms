...
<div class=" form_div" <?php echo isset($_SESSION['edit']) ? 'style="margin-top:30px;"' : '' ?>>
        ...
        <div class="col-12 col-lg-9 ml-auto mr-auto mb-4 sld_top <?php echo isset($_SESSION['edit']) ? 'hiden' : '' ?>">
          ...
          <div class="container emp-profile" <?php echo isset($_SESSION['edit']) ? 'style="padding:60px !important"' : '' ?> >
      ...
      <div class="col-md-8">
        <div class="profile-head">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
            <a  class="btn btn-default edit-btn <?php echo isset($_SESSION['edit']) ? '' : 'hiden' ?>" href="http://localhost/hamzaHrms/public/admins/add/3">Edit</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="row validat-div <?php echo isset($_SESSION['edit']) ? 'hiden' : '' ?>">
